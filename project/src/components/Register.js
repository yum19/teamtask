    ...
    <div style={containerStyle}>
      ...
      <div style={cardStyle}>
        ...
        <div style={{textAlign: 'center', marginBottom: '40px'}}>
          ...
          <h1 style={titleStyle}>Join TeamTask</h1>
        ...
        <form onSubmit={handleRegister}>
          ...
          <div style={inputContainerStyle}>
            <span style={{...iconStyle, color: nameFocused ? '#06b6d4' : '#94a3b8'}}>👤</span>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div style={inputContainerStyle}>
            <span style={{...iconStyle, color: confirmPasswordFocused ? '#06b6d4' : '#94a3b8'}}>🔐</span>
            <input
              ...
              style={{
                ...inputStyle,
                paddingRight: '56px',
                ...(confirmPasswordFocused ? inputFocusStyle : {})
              }}
            />
            <button
              type="button"
          ...
          {/* Role field */}
          <div style={inputContainerStyle}>
            <span style={{...iconStyle, color: roleFocused ? '#06b6d4' : '#94a3b8'}}>⭐</span>
            <select
              name="role"
              value={formData.role}
              onChange={handleChange}
